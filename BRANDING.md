# ERP LONGTECH Platform — Hướng dẫn Cá nhân hoá Thương hiệu / Branding Customization Guide

## Tổng quan / Overview

ERP LONGTECH Platform là hệ thống ERP mã nguồn mở, được thiết kế để doanh nghiệp dễ dàng cá nhân hoá thương hiệu (white-label). Mọi thông tin thương hiệu được quản lý tập trung tại package `@vierp/branding`.

ERP LONGTECH Platform is an open-source ERP system designed for easy white-label customization. All branding information is centrally managed in the `@vierp/branding` package.
...
console.log(brand.platform.name); // "ERP LONGTECH"
...
_Tài liệu này được tạo tự động bởi ERP LONGTECH Debranding Tool._
_This document was auto-generated by the ERP LONGTECH Debranding Tool._
