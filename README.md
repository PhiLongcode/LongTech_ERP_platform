# ERP LONGTECH Platform

**Nền tảng ERP mã nguồn mở cho doanh nghiệp / Open-source ERP platform for enterprises**

ERP LONGTECH Platform là hệ sinh thái ERP toàn diện, đạt chuẩn doanh nghiệp, được xây dựng bằng công nghệ web hiện đại. Nền tảng kế thừa từ VietERP và được tùy biến theo định hướng sản phẩm của LONGTECH.

ERP LONGTECH Platform is a comprehensive, enterprise-grade ERP ecosystem built with modern web technologies. It is based on VietERP and customized for LONGTECH's product direction.

### Screenshots

![Hero — ERP LONGTECH Landing Page](docs/screenshots/landing-hero.png)
...
ERP LONGTECH đi kèm bộ monitoring production-ready:
...
| Kubernetes  | Helm            | `helm install longtech ./charts/vierp -f values-production.yaml` |
...
ERP LONGTECH được thiết kế để dễ dàng cá nhân hoá thương hiệu:
...
## Attribution / Nguồn gốc mã nguồn

This project is based on [Viet-ERP](https://github.com/nclamvn/Viet-ERP), licensed under MIT.
Fork/customization maintained by LONGTECH with additional branding and configuration changes.

Dự án này kế thừa từ [Viet-ERP](https://github.com/nclamvn/Viet-ERP), phát hành theo giấy phép MIT.
Phiên bản tùy biến được LONGTECH duy trì với các thay đổi về thương hiệu và cấu hình.
